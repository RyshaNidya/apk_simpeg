            ...
            <div class="card-body">
                <form action="<?= base_url('_config/proses_profil') ?>?pass" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" class="form-control" name="password_baru2" id="password_baru2" placeholder="Konfirmasi Password" required >
                        </div>
                    </div>
            ...
            <div class="card-body">
                <form action="<?= base_url('_config/proses_profil') ?>?username" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="level" for="level" id= "level" class="form-control" >
