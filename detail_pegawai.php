...
<div class="row">
    <div class="col-md-4">
        <div style="background-color: #f1ffe7 ;" class="card shadow mb-4 border-left-success">
            <div class="card-body">
    ...
    <div class="col-md-8">
        <div style="background-color: #f1ffe7 ;" class="card shadow mb-4 border-bottom-success">
            <div class="card-body">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab">
                        ...
                        <a class="nav-item nav-link" id="nav-file-tab" data-toggle="tab" href="#nav-file" role="tab">Files</a>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <?php
                        require_once "detail_pegawai/files.php";
                    ?>
                    </div>
                </div>
            </div>
