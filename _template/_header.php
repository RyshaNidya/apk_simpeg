...
<body id="page-top" >
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="border border-dark navbar-nav color1 sidebar sidebar-dark accordion" id="accordionSidebar">

      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>">
        <!-- <div><img src="" width="100%"></div> -->
        <div class="sidebar-brand-text mx-5">SIMPEG</div>
      </a>
      ...
      <li class="nav-item  <?= isset($riwayat) == 'riwayat' ? 'active' : null ?>">
        ...
        <div id="collapseTwo" class="collapse " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="color2 border border-dark py-2 collapse-inner rounded ">
            <h6 style="color: black;" class="collapse-header">Tambah Riwayat:</h6>
            ...
            <a class="collapse-item <?= isset($files) == 'files' ? 'active' : null ?>" href="<?= base_url('files') ?>">Dosir</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" >
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-dark color2   topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span style="color: black;" class="mr-2 d-none d-lg-inline  large "><?= $user[0]['username'] ?></span>
                <img class="img-profile rounded-circle" alt="Image" src="<?= asset('_assets/img/profil2.png') ?>">
              </a>
