...
<div class="table-responsive mt-3">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url('_config/proses_delpan') ?>?id=<?= $pangkat['id_pangkat'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Menghapus Data?')"><i class="fas fa-trash"></i> Hapus</a>
    ...
    <a href="<?= base_url('pangkat') ?>" class="btn btn-info btn-sm "><i class="fa fa-plus"></i>  Tambah</a>
