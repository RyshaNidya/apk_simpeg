...
<div class="table-responsive mt-3">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <a href="<?= base_url('_config/proses_delpen') ?>?id=<?= $pendidikan['id_pendidikan'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Menghapus Data?')"><i class="fas fa-trash"></i> Hapus</a>
    ...
    <a href="<?= base_url('pendidikan') ?>" class="btn btn-info btn-sm "><i class="fa fa-plus"></i>  Tambah</a>
</div>