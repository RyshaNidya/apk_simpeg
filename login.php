            ...
            <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <form class="user" method="POST" action="<?= base_url('_config/proses_log') ?>?login">
                      ...
                      <button type="submit" class="btn btn-success btn-user btn-block"><i class="fas fa-fw fa-sign-in-alt"></i> Login</button>
                    </form>
                </div>
            </div>

            <div class="col-lg-6 d-none d-lg-block">
                <img src="<?= asset('_assets/img/design/login1.png') ?>" class="ml-n5" alt="login" width="110%">
            </div>
